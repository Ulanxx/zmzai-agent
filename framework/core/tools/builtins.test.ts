...
import { bashTool, editTool, globTool, grepTool, readTool, todoTool, writeTool } from "@/framework/core/tools/builtins";
  ...
  return {
    ...
    workspace: {
      ...
      read: vi.fn().mockImplementation(async (path: string) =>
        path === "src/index.ts" ? { path, content: "import x from './util/helper';\nconsole.log(x);\n// TODO fix" } : null,
      ),
