...
export function AgentWorkbench({ workspaceId, agentId }: { workspaceId: string; agentId: string }) {
  ...
  return (
    <main className="agent-workbench">
      ...
      <section className="agent-skill-drawer">
        <div className="agent-skill-drawer-head"><div><span className="eyebrow">GITHUB SKILLS</span><h2>为这个 Agent 选择受管技能</h2></div><span>{selectedSkillIds.length} 已启用</span></div>
      ...
      <section className="agent-skill-drawer agent-plugin-drawer">
        <div className="agent-skill-drawer-head"><div><span className="eyebrow">AGENT PLUGINS 1.0</span><h2>导入可移植的能力包</h2></div><span>{selectedPluginIds.length} 已启用</span></div>
      ...
      <section className="agent-skill-drawer agent-connector-drawer">
        <div className="agent-skill-drawer-head"><div><span className="eyebrow">MCP CONNECTORS</span><h2>授权外部工具连接</h2></div><span>{selectedConnectorIds.length} 已启用</span></div>
